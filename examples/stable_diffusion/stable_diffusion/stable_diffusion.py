...
def index():
    ...
    return rc.center(
        rc.vstack(
            rc.heading("Stable Diffusion", font_size="2em"),
            rx.upload(
                rc.vstack(
                    rc.button(
                        rc.text("Select File"),
                    ...
                    rc.text("Drag and drop files here or click to select files"),
                ),
            ...
            rc.image(src=State.most_recent_upload, style=image_style),
            rc.vstack(
                rc.input(
                ...
                rc.text("Number of inference steps: " + State.inference_steps),
                rc.slider(
                ...
                rc.text("Strength of diffusion: " + State.strength_diffusion),
                rc.slider(
            ...
            rx.cond(
                ...
                rx.cond(
                    State.image_made,
                    rc.image(src=State.image, style=image_style),
                ),
            ),
            bg=border_color,
            padding="2em",
